<footer class="bg-tertiary-200/50 border-t border-tertiary-300/40 text-neutral-700 py-10 mt-16 font-body-ar">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
        ...
        <nav class="flex flex-wrap items-center justify-center gap-6 text-sm font-medium text-neutral-600">
            ...
            <a href="{{ route('contact') }}" class="hover:text-primary transition-colors">اتصل بنا</a>
        </nav>

        <!-- Social Media Links -->
        <div class="flex items-center justify-center gap-4 text-neutral-500">
            <!-- Facebook -->
            <a href="{{ \App\Models\Setting::get('facebook_url', 'https://www.facebook.com/share/19CMhfvDnZ/') }}" target="_blank" rel="noopener noreferrer" class="p-2 rounded-full hover:text-[#1877F2] hover:bg-surface transition-colors" aria-label="فيسبوك" title="فيسبوك كشك الورد">
                <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
                    <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                </svg>
            </a>
            <!-- Instagram -->
            <a href="{{ \App\Models\Setting::get('instagram_url', 'https://www.instagram.com/keshkalward.kshk?utm_source=qr&stkn=am5rYTZrdmw5dmU=') }}" target="_blank" rel="noopener noreferrer" class="p-2 rounded-full hover:text-pink-600 hover:bg-surface transition-colors" aria-label="انستغرام" title="انستغرام كشك الورد">
                <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
