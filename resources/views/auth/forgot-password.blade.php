            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input 
                        ...
                        class="w-full bg-tertiary-50 border border-neutral-200 focus:border-primary focus:ring-1 focus:ring-primary rounded-2xl ps-4 pe-10 py-3 text-xs md:text-sm text-start placeholder:text-start font-body text-neutral-800 transition-colors"
                    >
                </div>
