                ...
                <div class="bg-surface rounded-3xl p-6 md:p-8 shadow-card border border-neutral-100 space-y-6">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-tertiary-200 text-primary flex items-center justify-center flex-shrink-0 shadow-sm">
                        ...
                        <!-- WhatsApp Direct -->
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center flex-shrink-0 shadow-sm">
                        ...
                        <!-- Facebook -->
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-blue-50 text-[#1877F2] flex items-center justify-center flex-shrink-0 shadow-sm">
                                <svg class="w-5 h-5 sm:w-6 sm:h-6 fill-current" viewBox="0 0 24 24">
                        ...
                        <!-- Instagram -->
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-pink-50 text-pink-600 flex items-center justify-center flex-shrink-0 shadow-sm">
                                <svg class="w-5 h-5 sm:w-6 sm:h-6 fill-current" viewBox="0 0 24 24">
